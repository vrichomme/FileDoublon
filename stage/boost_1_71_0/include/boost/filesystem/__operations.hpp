...
//--------------------------------------------------------------------------------------//
  ...
  namespace detail
  {
    ...
    void create_directory_symlink(const path& to, const path& from,
                                  system::error_code* ec=0, bool useJunction=true);
    BOOST_FILESYSTEM_DECL
...
# endif
  ...
  inline
  void create_directory_symlink(const path& to, const path& from, system::error_code& ec, bool useJunction = true) BOOST_NOEXCEPT
